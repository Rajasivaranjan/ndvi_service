...
class EERasterBuilder:
    ...
    def __init__(self, start: str = '2020-01-01', end: str = '2021-01-31', reducer_fc: str = 'median'):
        self.start = start
        self.end = end
    ...
    def get_feature_identifiers(self):
        ...
        if self.reducer is None:
            ...
            band_ids = [self.code + self.date_code + name + '_' + self.reducer for name in bands]
